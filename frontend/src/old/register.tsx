...
export default () => {
  return (
    ...
    >
      <div
        className={cn(
          "flex flex-1 pt-25 pb-10 justify-stretch",
          css`
      ...
      <div className="page-form--form flex-1 flex items-center justify-center">
        <div
          className={cn(
            "p-20 pt-5 pb-1 bg-white w-fit flex items-center justify-center",
            css`
              margin: 20px;
              border-radius: 35px;
          ...
          <div className="p-8 w-full max-w-md">
            ...
            <div className="content">
              ...
              <p className="text-sm text-gray-600 mb-7">
                Create your GoFundItNow account. We require a work email address
