...
export default () => {
  ...
  // Watch for QA completion (auto)
  if (ai.local.mode === "auto" && ai.local.summary && ai.local.phase.qa) {
    location.href = "/profile";
    return null;
  }

  // Watch for QA completion (manual)
  if (ai.local.mode === "manual" && ai.local.phase.qa) {
    location.href = "/profile";
    return null;
  }
