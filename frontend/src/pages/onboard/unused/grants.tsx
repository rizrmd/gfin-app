          ...
          <Popover>
            <PopoverTrigger asChild>
              ...
              >
                ...
                {grantRead.filters.date ? (
                  format(new Date(grantRead.filters.date), "PPP")
                ) : (
            ...
            <PopoverContent className="w-auto p-0" align="start">
              <Calendar
                ...
                selected={
                  grantRead.filters.date
                    ? new Date(grantRead.filters.date)
                    : undefined
                }
                onSelect={(date) => {
                  grantState.write.filters.date = date
                    ? date.toISOString()
                    : "";
                }}
                initialFocus
...
export default () => {
  ...
  return (
    <BodyFrame className="min-h-screen bg-gray-50">
      <section
        className={cn(
          "w-full pb-5",
          css`
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Browse and filter available grants
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center gap-2 sm:gap-4 mb-6">
                ...
                <div className="flex-1 relative">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      (grantState.write.filters.search = e.target.value)
                    }
                  />
                </div>
                      ...
                      {filteredGrants.map((grant, index) => (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 mt-3 sm:mt-0">
                            ...
                            <Button className="bg-blue-600 hover:bg-blue-700 text-white px-3 h-8 text-sm rounded-full">
                              Summarise
                            </Button>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-1">
                          <Button
                            ...
                            onClick={() =>
                              grantState.setPage(
                                grantRead.pagination.currentPage - 1
                              )
                            }
                          ...
                          {Array.from(
                            { length: grantState.getTotalPages() },
                            (_, i) => i + 1
                          ).map((page) => (
                            <Button
                              key={page}
                              ...
                              className={cn(
                                ...
                                page === grantRead.pagination.currentPage &&
                          ...
                          <Button
                            ...
                            disabled={
                              grantRead.pagination.currentPage ===
                              grantState.getTotalPages()
                            }
                          >
